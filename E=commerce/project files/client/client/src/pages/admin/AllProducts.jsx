                ...
                <div className="all-product-filter-sort">
                    ...
                    <div className="all-product-filter-sort-body all-product-sub-filter-body">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" htmlFor="filter-sort-radio1" >
                                Popularity
                            </label>
                        </div>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" htmlFor="filter-sort-radio3">
                                Price (high to low)
                            </label>
                        </div>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" htmlFor="filter-sort-radio4">
                                Discount
                            </label>
                        </div>
                        ...
                        {categories.map((category)=>{
                            return(
                                <div class="form-check" key={category}>
                                    ...
                                    <label class="form-check-label" htmlFor={'productCategory'+ category}>
                                        {category}
                                    </label>
                                </div>
                            )
                ...
                <div className="all-product-filter-gender">
                    ...
                    <div className="all-product-filter-gender-body all-product-sub-filter-body">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" htmlFor="filter-gender-check-1">
                                Men
                            </label>
                        </div>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" htmlFor="filter-gender-check-2">
                                Women
                            </label>
                        </div>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" htmlFor="filter-gender-check-3">
                                Unisex
                            </label>
                        </div>
