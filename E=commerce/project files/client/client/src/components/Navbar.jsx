  ...
  return (
    ...
    <>
      ...
      {!usertype ?
          ...
          <h3 onClick={()=> navigate('')} >shopsite</h3>
        ...
        : <>
            ...
            {usertype === 'customer' ?
                ...
                <div className="navbar">
                  ...
                  <div className="nav-content">
                    <div className="nav-search">
                      ...
                      {
                        noResult === true ?
                          <div className='search-result-data'>no items found <ImCancelCircle className='search-result-data-close-btn' onClick={()=> setNoResult(false)}  /></div>
                        :
                        ""
                      }
                    </div>
              ...
              <div className="navbar-admin">
                <h3 onClick={()=> navigate('/admin')}>shopsite (admin)</h3>
